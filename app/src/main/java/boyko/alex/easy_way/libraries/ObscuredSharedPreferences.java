...
public class ObscuredSharedPreferences implements SharedPreferences {
    ...
    public ObscuredSharedPreferences(Context context, SharedPreferences delegate) {
        ...
        ObscuredSharedPreferences.setNewKey(Secure.getString(context.getContentResolver(), Secure.ANDROID_ID));
        ObscuredSharedPreferences.setNewSalt(Secure.getString(context.getContentResolver(), Secure.ANDROID_ID));
    }
