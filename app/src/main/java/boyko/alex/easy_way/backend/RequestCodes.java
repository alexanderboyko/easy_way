...
public class RequestCodes {
    ...
    public static int REQUEST_CODE_DETAILS = 5;
    public static int REQUEST_CODE_SETTINGS = 6;

    public static int RESULT_CODE_SELECTED = 20;
    public static int RESULT_CODE_CANCELED = 21;
    public static int RESULT_CODE_OK = 22;
    public static int RESULT_CODE_PROFILE_EDITED = 23;
}
